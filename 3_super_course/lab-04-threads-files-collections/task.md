...
* подготовки программного кода, отчёта и блок-схем.
...
## 4. Предметная область (общая для всех студентов)
...
## 12. Блок-схемы (обязательно)

В отчёте должны присутствовать блок-схемы:

1. Общий алгоритм работы программы;
2. Алгоритм сохранения данных в файл;
3. Алгоритм работы потока.

Блок-схемы можно выполнять:

* в draw.io;
* в Visio;
* от руки (аккуратно, с подписями).
...
6. Блок-схемы
7. Примеры работы программы (скриншоты консоли)
...
| Критерий                      | Баллы |
| ----------------------------- | ----- |
| Работоспособность программы   | 30    |
| Использование потоков         | 20    |
| Работа с файлами              | 20    |
| Использование коллекций и ООП | 20    |
| Отчёт и защита                | 10    |
...
## 17. Результат выполнения лабораторной работы
